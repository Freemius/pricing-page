  ...
  render() {
    ...
    switch (plugin.refund_policy) {
      case RefundPolicyType.FLEXIBLE:
        ...
        refundPolicy = (
          <Fragment>
            ...
            don't like our {plugin.moduleLabel()} over the next{' '}
            {plugin.money_back_period} days, we'll happily refund 100% of your
      ...
      case RefundPolicyType.MODERATE:
        ...
        refundPolicy = `You are fully protected by our 100% Satisfaction Guarantee. If over the next ${
          plugin.money_back_period
        } days you are unhappy with our ${plugin.moduleLabel()} or have an issue that we are unable to resolve, we'll happily consider offering a 100% refund of your money.`;
        break;
      case RefundPolicyType.STRICT:
      default:
        refundType = 'Money Back Guarantee';
        refundPolicy = `You are fully protected by our 100% Money Back Guarantee. If during the next ${
          plugin.money_back_period
        } days you experience an issue that makes the ${plugin.moduleLabel()} unusable and we are unable to resolve it, we'll happily consider offering a full refund of your money.`;
        break;
    }

    return (
      <Fragment>
        <h2 className="fs-money-back-guarantee-title">
          {plugin.money_back_period}-day {refundType}
        </h2>
          ...
          <div className="fs-modal fs-modal--refund-policy">
            <section className="fs-modal-content-container">
              ...
              <div className="fs-modal-content">
                <p>{refundPolicy}</p>
                <p>
                  Just start a refund ticket through the "Contact Us" in the
                  plugin's admin settings and we'll process a refund.
                </p>
                <p>
