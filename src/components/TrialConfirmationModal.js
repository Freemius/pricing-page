      ...
      <div className="fs-modal fs-modal--trial-confirmation">
        <section className="fs-modal-content-container">
          ...
          <div className="fs-modal-content">
            <p>
              <strong>
                You are 1-click away from starting your {plan.trial_period}-day
                free trial of the {plan.title} plan.
              </strong>
            </p>
            <p>
              For compliance with the WordPress.org guidelines, before we start
              the trial we ask that you opt in with your user and non-sensitive
              site information, allowing the {plugin.type} to periodically send
              data to{' '}
