  ...
  const showTooltip = () => {
    ...
    setCurrentTooltipPosition(currentPosition => {
      ...
      const packagesContainer =
        tooltipMessageRef.current.closest('.fs-packages-nav');
      ...
      let spaceAvailableOnRightOfPackagesContainer =
        packagesRect.right - rect.right;
      let neededTooltipSpaceOnRight =
        WIDTH_OF_TOOLTIP_CONTAINER + BREATHING_SPACE;
      ...
      if (
        neededTooltipSpaceOnRight > spaceAvailableOnRightOfPackagesContainer
      ) {
        position = 'top';
        neededTooltipSpaceOnRight =
          WIDTH_OF_TOOLTIP_CONTAINER / 2 + BREATHING_SPACE;
